...
KEYRING_FILE=archzfs.gpg
KEYRING_REVOKED_FILE=archzfs-revoked
KEYRING_TRUSTED_FILE=archzfs-trusted
PROJECT=archzfs-keyring
WKD_SYNC_SCRIPT=archzfs-keyring-wkd-sync
WKD_SYNC_SERVICE_IN=archzfs-keyring-wkd-sync.service.in
WKD_SYNC_SERVICE=archzfs-keyring-wkd-sync.service
WKD_SYNC_TIMER=archzfs-keyring-wkd-sync.timer
